 ...
 */
class Leadaus extends BaseController
{
    /**
    ...
    {
        parent::__construct();
        $this->load->model('admin/leadaus_model');
    }
    ...
    public function index()
    {
        ...
        $this->loadViews("admin/leadaus/list", $this->global, NULL , NULL);
    ...
    public function addnew()
    {
        ...
        $this->loadViews("admin/leadaus/addnew", $this->global, NULL , NULL);
    ...
    {
        $list = $this->leadaus_model->get_datatables();
    ...
    public function edit($id = NULL)
    {
        ...
        $data['edit_data'] = $this->leadaus_model->find($id);
        $this->global['pageTitle'] = 'MyFoodAndSons : Edit Blog Content';
        $this->loadViews("admin/leadaus/edit", $this->global, $data , NULL);
    ...
    public function update()
    {
        ...
        {   
            ...
            redirect('admin/leadaus/edit/'.$insertData['id']);
          }  
    ...
    { 
         ...
         if(isset($form_data['slug_url']))
         {
                ...
                $slug_url = strtolower($form_data['slug_url']);
                 ...
                 $where['status']  = 1 ;
                 $result  = $this->leadaus_model->findDynamic($where);
      ...
      function delete()
    {
        ...
        $result = $this->leadaus_model->delete($delId);           
