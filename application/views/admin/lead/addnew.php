    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="<?php echo base_url()?>admin/lead">Leads List</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form role="form" id="member_form" action="<?php echo base_url() ?>admin/lead/insertnow" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="tinymce-editor" name="issue"></textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="remote_tool" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="remote_id" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="remote_password" class="form-control">
                  </div>
                </div>
